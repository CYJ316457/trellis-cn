...
Wrap up the current session: archive the active task (and any other completed-but-unarchived tasks the user wants to clean up) and record the session journal. Code commits are NOT done here 鈥?those happen in workflow Phase 3.4 before you invoke this command.
